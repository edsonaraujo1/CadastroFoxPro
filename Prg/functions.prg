...
**************************************
* Indentifica Santana ou Santo Amaro *
**************************************
Do Case
   Case UPPER(msenha) = "CAIXA"
        ThisForm.Command4.Enabled =.F.
        ThisForm.Command5.Enabled =.F.
        ThisForm.Command6.Enabled =.F.
        ThisForm.Label18.Enabled  =.F.
        ThisForm.Label21.Enabled  =.F.

   Case UPPER(msenha) = "AVEMG"
        ThisForm.Command4.Enabled =.F.
        ThisForm.Command5.Enabled =.F.
   ...
   Case UPPER(msenha) = "HEWXT"
        ThisForm.Command4.Enabled =.T.
        ThisForm.Command5.Enabled =.T.
        ThisForm.Command6.Enabled =.T.
        ThisForm.Label18.Enabled  =.T.
        ThisForm.Label21.Enabled  =.T.
        ThisForm.Label18.Enabled = .T.
        ThisForm.Label28.Enabled  =.T.

   Case UPPER(msenha) = "ZE"
        ThisForm.Command4.Enabled =.T.
        ThisForm.Command5.Enabled =.T.
        ThisForm.Command6.Enabled =.T.
        ThisForm.Label18.Enabled  =.T.
   ...
   Case UPPER(msenha) = "COBRA"
        ThisForm.Command4.Enabled =.F.
        ThisForm.Command5.Enabled =.F.
        ThisForm.Command6.Enabled =.F.
        ThisForm.Label18.Enabled  =.F.
        ThisForm.Label21.Enabled  =.F.
        ThisForm.Label28.Enabled  =.F.

   Case UPPER(msenha) = "FTN"
        ThisForm.Command4.Enabled =.T.
        ThisForm.Command5.Enabled =.T.
        ThisForm.Command6.Enabled =.T.
        ThisForm.Label18.Enabled  =.T.
